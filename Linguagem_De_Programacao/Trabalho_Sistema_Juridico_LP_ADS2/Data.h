...
void Data::leitura() {
	...
	cout << "\n\t Leitura da Data: ";
	cout << "\n\t ======================================================== " << endl;
	cout << "\n\t Informe o dia (não digitar o 0 à esquerda se dia for anterior ao 10): ";
	cin >> dia;

	// Verificação caso seja informado um dia inválido
	dia = dia > 30 || dia < 0 ? 1 : dia;

	cout << "\n\t Informe o mês (não digitar o 0 à esquerda se mês for anterior ao 10): ";
	cin >> mes;

	// Verificação caso seja informado um mês inválido
