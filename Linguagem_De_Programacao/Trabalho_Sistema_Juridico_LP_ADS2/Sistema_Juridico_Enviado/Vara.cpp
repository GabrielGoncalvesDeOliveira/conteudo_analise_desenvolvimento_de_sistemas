...
int main() {
	...
	cout << "\n\t Abaixo segue a impressão dos dados da 1º Vara " << endl;
	primeiraVara.impressao();

	cout << "\n\t Abaixo segue a impressão completa dos dados da 1º Vara " << endl;
	...
	cout << "\n\t Abaixo segue a impressão dos dados da 2º Vara " << endl;
	...
	cout << "\n\t Abaixo segue a impressão dos dados da 3º Vara " << endl;
